...
class faceMeshDetector():
    ...
    def __init__(self,  stateMode = False, maxFaces = 2, minDetectionCon = 0.5, minTrackCon = 0.5):
        ...
        self.faceMesh = self.mpFaceMesh.FaceMesh(self.stateMode, self.maxFaces, self.minDetectionCon, self.minTrackCon)
